...
<CalloutBox icon="IconStarFilled" title="Want to create a new journey?" type="fyi">
See [Create customer journeys](/docs/customer-analytics/create-customer-journeys) for step-by-step instructions.
</CalloutBox>
